...
graph TD
    A(人工智能 AI) --> B(机器学习 ML);
    B --> C([监督学习](/AI/01a_机器学习基础?id=_2-监督学习-supervised-learning));
    B --> D([无监督学习](/AI/01a_机器学习基础?id=_3-无监督学习-unsupervised-learning));
    B --> E([强化学习 RL](/AI/03_强化学习(RL)));
    B --> F([深度学习 DL](/AI/01b_深度学习基础));
    F --> G([神经网络 NN](/AI/01b_深度学习基础?id=_2-人工神经网络-ann-基础));
